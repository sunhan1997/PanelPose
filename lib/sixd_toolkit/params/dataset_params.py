...
def get_dataset_params(name, model_type='', train_type='', test_type='',
    ...
    common_base_path = '/media/sunh/Samsung_T5/6D_data/EfficientPose/Linemod_preprocessed'
    ...
    if name == 'hinterstoisser':
        ...
        p['base_path'] = pjoin(common_base_path)
        p['im_id_pad'] = 4
    ...
    p['scene_info_mpath'] = pjoin(p['base_path'], 'data/{}', 'info.yml')
    p['scene_gt_mpath'] = pjoin(p['base_path'], 'data/{}', 'gt.yml')
    # p['scene_gt_stats_mpath'] = pjoin(p['base_path'] + '_gt_stats', '{:02d}_delta={}.yml')
    p['test_rgb_mpath'] = pjoin(p['base_path'],  'data/{}', 'rgb', im_id_f + '.png')
    p['test_depth_mpath'] = pjoin(p['base_path'],  'data/{}', 'depth', im_id_f + '.png')
    p['test_mask_mpath'] = pjoin(p['base_path'],  'data/{}', 'mask', im_id_f + '_{:02d}.png')
    # p['test_mask_visib_mpath'] = pjoin(p['base_path'], '{:02d}', 'mask_visib', im_id_f + '_{:02d}.png')
