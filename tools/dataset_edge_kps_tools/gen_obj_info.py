...
parser.add_argument(
    "--obj_name", type=str, default="panel4", help="Object name."
)
parser.add_argument(
    "--obj_pth", type=str, default="/home/robot/github/PanelPose/tools/dataset_edge_kps_tools/example_mesh/panel4.ply",
    help="path to object ply."
)
parser.add_argument(
    "--sv_fd", default='/home/robot/github/PanelPose/tools/dataset_edge_kps_tools/RAL',type=str, help="path to save the generated mesh info."
)
parser.add_argument(
    '--scale2m', type=float, default=1000.0,
    help="scale to transform unit of object to be in meter."
)
parser.add_argument(
    '--vis', default='False',action="store_true", help="visulaize rendered images."
)
parser.add_argument(
...
parser.add_argument(
    '--K', type=int, default=[623.6400146484375, 0, 319.4993591308594, 0, 623.6400756835938, 232.33065795898438, 0, 0, 1],  
...
parser.add_argument(
    '--extractor', type=str, default="EDGE",
    help="2D keypoint extractor, EDGE or FLD"
)
parser.add_argument(
    '--n_keypoint', type=int, default= 8 ,   ###################  point number
...
def gen_one_mesh_info(args, obj_pth, sv_fd):
    ...
    with open(fps_pth, 'w') as of:
        for p3d in fps:
            print(p3d[0]*1000, p3d[1]*1000, p3d[2]*1000, file=of)
